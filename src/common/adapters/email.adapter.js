...
var EmailAdapter = /** @class */ (function () {
    ...
    EmailAdapter.prototype.sendEmail = function (messageInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var transport, info, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, transport.sendMail(messageInfo)];
                    case 2:
                        info = _a.sent();
                        console.log(info);
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
                        console.log(e_1);
                        throw new Error("Email server error! : ".concat(e_1));
